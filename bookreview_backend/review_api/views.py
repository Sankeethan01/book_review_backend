...
class ReviewViewSet(ModelViewSet):
    ...
    permission_classes = [IsAuthenticatedOrReadOnly]  # Allow anyone to read, but authentication required to post

    def perform_create(self, serializer):
        """
        ✅ Automatically assigns the logged-in user to the review.
        ✅ Prevents frontend from manually sending "user" field.
        """
